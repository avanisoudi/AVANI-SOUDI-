...
async function anticallCommand(sock, chatId, message, args) {
    ...
    const enable = sub === 'on';
    writeState(enable);
    await sock.sendMessage(chatId, { text: `Anticall est maintenant *${enable ? 'activé' : 'désactivé'}*.` }, { quoted: message });
}
