...
function loadAutoReactionState() {
    try {
        ...
        console.Erreur('Erreur loading auto-reaction state:', Erreur);
    }
    return false;
}
...
function saveAutoReactionState(state) {
    try {
        ...
        console.Erreur('Erreur saving auto-reaction state:', Erreur);
    }
}
...
async function addCommandReaction(sock, message) {
    try {
        ...
        console.Erreur('Erreur adding command reaction:', Erreur);
    }
}
...
async function handleAreactCommand(sock, chatId, message, isOwner) {
    try {
        ...
        console.Erreur('Erreur handling areact command:', Erreur);
        await sock.sendMessage(chatId, { 
