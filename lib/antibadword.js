...
function loadAntibadwordConfig(groupId) {
    try {
        ...
        console.error('❌ Erreur loading antibadword config:', Erreur.message);
        return {};
    }
}
...
async function handleBadwordDetection(sock, chatId, message, userMessage, senderId) {
   ...
   // console.log('Bad word detected in:', userMessage);
    ...
    try {
        ...
        console.error('Erreur deleting message:', err);
        return;
    }
    ...
    switch (antiBadwordConfig.action) {
        ...
        case 'kick':
            try {
                ...
                console.error('Erreur kicking user:', Erreur);
            }
            break;
        ...
        case 'warn':
            ...
            if (warningCount >= 3) {
                try {
                    ...
                    console.error('Erreur kicking user after warnings:', Erreur);
                }
            } else {
                await sock.sendMessage(chatId, {
